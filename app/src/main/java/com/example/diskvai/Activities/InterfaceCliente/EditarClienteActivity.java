...
public class EditarClienteActivity extends AppCompatActivity {
    ...
    String id_cliente, nome_cliente, email_cliente, login_cliente, telefone_cliente;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        read();
        nome.setText(nome_cliente);
        email.setText(email_cliente);
        login.setText(login_cliente);
        telefone.setText(telefone_cliente);
        ...
        btnEditar.setOnClickListener(view -> {
            if (validaCadastro()) {
                try {
                    ...
                    HttpUrl.Builder urlBuilder = HttpUrl.parse("http://gabriellacastro.com.br/disk_vai/editarCliente.php").newBuilder();
                    urlBuilder.addQueryParameter("id", id_cliente);
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    try {
                                        ...
                                        if(a[1].split("'")[0].equals("Cadastro Editado com Sucesso!")){
