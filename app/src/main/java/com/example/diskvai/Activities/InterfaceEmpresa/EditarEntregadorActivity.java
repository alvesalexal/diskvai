...
public class EditarEntregadorActivity extends AppCompatActivity {
    ...
    String id_entregador, nome_entregador, email_entregador, login_entregador, telefone_entregador;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_editar_entregador);
        Intent intent = this.getIntent();
        id_entregador = intent.getStringExtra("ID");
        nome_entregador = intent.getStringExtra("Nome");
        email_entregador = intent.getStringExtra("Email");
        login_entregador = intent.getStringExtra("Login");
        telefone_entregador = intent.getStringExtra("Telefone");


        read();
        nome.setText(nome_entregador);
        email.setText(email_entregador);
        login.setText(login_entregador);
        telefone.setText(telefone_entregador);
