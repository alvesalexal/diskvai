...
public class TratamentoDados {
    ...
    public boolean isCPF(String CPF) {
        ...
        CPF = removePontuacaoCpfCnpj(CPF);
    ...
    public boolean isCNPJ(String CNPJ) {
        ...
        CNPJ = removePontuacaoCpfCnpj(CNPJ);
    ...
    private String removePontuacaoCpfCnpj(String doc) {
        if (doc.contains(".")) {
            doc = doc.replace(".", "");
        }
        if (doc.contains("-")) {
